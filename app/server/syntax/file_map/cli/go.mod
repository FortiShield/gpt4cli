...
replace gpt4cli-server => ../../../

replace gpt4cli-shared => ../../../../shared

replace gpt4cli-cli => ../../../../cli

replace github.com/khulnasoft-lab/go-prompt => github.com/khulnasoft/go-prompt v0.0.0-20250312144254-f7a6a493dfb8

require (
	gpt4cli-cli v0.0.0-00010101000000-000000000000
	gpt4cli-server v0.0.0-00010101000000-000000000000
