...
const (
	SchemaUrlInputConfig     SchemaUrl = "https://gpt4cli.khulnasoft.com/schemas/models-input.schema.json"
	SchemaUrlPlanConfig      SchemaUrl = "https://gpt4cli.khulnasoft.com/schemas/plan-config.schema.json"
	SchemaUrlInlineModelPack SchemaUrl = "https://gpt4cli.khulnasoft.com/schemas/model-pack-inline.schema.json"
)
